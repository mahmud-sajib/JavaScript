...
if (isMarried == "yes") {
    ...
    console.log(name + " is not married yet."); // outputs: John is not married yet.
}
...
if (isMarried) {
    console.log(name + " is married."); // outputs: John is not married.
} else {
...
if (20 === "20") {
    ...
    console.log("It's not okay"); // outputs: It's not okay
}
